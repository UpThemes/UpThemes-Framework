...
function upfw_upthemes_admin() {
    ...
    add_menu_page($name, $name, 'update_core', 'upthemes', 'upthemes_admin_home', $theme_options_icon, 59);
	...
	if( is_array( $up_tabs ) ):
		foreach ($up_tabs as $tab):
			foreach($tab as $title => $shortname):
				add_submenu_page('upthemes', $title, $title, 'update_core', 'upthemes#/'.$shortname, 'upthemes_admin_'.$shortname);
			endforeach;
		endforeach;
	endif;

	//Static subpages
	add_submenu_page('upthemes', __('Import/Export','upfw'), __('Import/Export','upfw'), 'update_core', 'upthemes#/import-export', 'upthemes_admin_import_export');
	add_submenu_page('upthemes', __('Documentation','upfw'), __('Documentation','upfw'), 'update_core', 'upthemes-docs', 'upthemes_admin_docs');
	add_submenu_page('upthemes', __('Buy Themes','upfw'), __('Buy Themes','upfw'), 'update_core', 'upthemes-buy', 'upthemes_admin_buy');
